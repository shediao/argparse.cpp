    ...
    if (is_position_arg(curr_arg)) {
      ...
      std::visit(
          overloaded{
              ...
              [&current_position_it, &curr_arg](
                  std::vector<std::string>& x) -> std::pair<int, std::string> {
              ...
              [&revisit, &current_position_it, &curr_arg](
                  std::reference_wrapper<std::map<std::string, std::string>>& x)
                  -> std::pair<int, std::string> {
                auto const i = curr_arg.find('=');
                if (i == std::string::npos) {
                  current_position_it++;
